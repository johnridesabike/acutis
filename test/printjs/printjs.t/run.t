  ...
  {@tag: \"b\", open_enum: @0 | @1 | ...}"
    ...
    buffer$0.push(runtime_escape$0(props$0.get("big_int").toString()));
    buffer$0.push("\n%f    ");
    buffer$0.push(runtime_escape$0(props$0.get("big_float").toString()));
    buffer$0.push("\n%b    ");
    buffer$0.push(runtime_escape$0(props$0.get("bool1") ? "true" : "false"));
    buffer$0.push("\n%b    ");
    buffer$0.push(runtime_escape$0(props$0.get("bool2") ? "true" : "false"));
    buffer$0.push("\n\nEscaping\n--------\n\nEscaped     ");
    buffer$0.push(runtime_escape$0(props$0.get("dangerous")));
    buffer$0.push("\nNot escaped ");
    buffer$0.push(props$0.get("dangerous"));
    buffer$0.push("\n\nNullable echo chaining\n----------------------\n\n");
    if (!(props$0.get("null_int") === 0)) {
      buffer$0.push(runtime_escape$0(props$0.get("null_int")[0].toString()));
    } else {
      if (!(props$0.get("null_float") === 0)) {
        buffer$0.push(
          runtime_escape$0(props$0.get("null_float")[0].toString())
        );
      } else {
        if (!(props$0.get("null_bool") === 0)) {
          buffer$0.push(
            runtime_escape$0(props$0.get("null_bool")[0] ? "true" : "false")
          );
        } else {
          if (!(props$0.get("null_string") === 0)) {
            buffer$0.push(runtime_escape$0(props$0.get("null_string")[0]));
          } else {
            buffer$0.push(runtime_escape$0("pass"));
          }
        }
      }
    }
    ...
    if (exit$2 === 0) {
      buffer$0.push(runtime_escape$0(props$3.get("a")));
      buffer$0.push("\n");
    } else {
      buffer$0.push(runtime_escape$0(props$3.get("b").toString()));
      buffer$0.push("\n");
    }
    ...
    if (exit$3 === 0) {
      ...
      buffer$0.push(runtime_escape$0(props$4.get("a").toString()));
      buffer$0.push(" ");
      buffer$0.push(runtime_escape$0(props$4.get("b")));
      buffer$0.push(" ");
      buffer$0.push(runtime_escape$0(props$4.get("c") ? "true" : "false"));
      buffer$0.push("\n");
    }
    ...
    for (let x$0 of arg$10) {
      ...
      if (exit$5 === 0) {
        buffer$0.push(runtime_escape$0(props$6.get("key")));
        buffer$0.push(" is null.\n");
      } else {
        buffer$0.push(runtime_escape$0(props$6.get("key")));
        buffer$0.push(" is ");
        buffer$0.push(runtime_escape$0(props$6.get("str")));
        buffer$0.push("\n");
      }
    }
    let index$0 = 0;
    ...
    while (!(cell$0 === 0)) {
      ...
      buffer$0.push(runtime_escape$0(props$6.get("i").toString()));
      buffer$0.push("\n");
      index$0++;
      cell$0 = list$0[1];
    }
    ...
    while (!(cell$1 === 0)) {
      ...
      props$6.set("i", arg$12);
      props$6.set("key", arg$13);
      buffer$0.push(runtime_escape$0(props$6.get("key").toString()));
      buffer$0.push(" : ");
      buffer$0.push(runtime_escape$0(props$6.get("i").toString()));
      buffer$0.push("\n");
      index$1++;
    ...
    while (!(cell$2 === 0)) {
      ...
      while (!(cell$3 === 0)) {
        ...
        while (!(cell$4 === 0)) {
          ...
          buffer$0.push(runtime_escape$0(props$8.get("i").toString()));
          buffer$0.push(" ");
          index$4++;
          cell$4 = list$2[1];
        }
    ...
    while (!(cell$3 === 0)) {
      ...
      if (exit$5 === 0) {
        ...
        if (exit$5 === 1) {
          ...
          buffer$0.push(runtime_escape$0(props$6.get("b") ? "true" : "false"));
          buffer$0.push("\n");
        }
      }
      index$3++;
  ...
  "
    ...
    if (exit$5 === 0) {
      ...
      buffer$0.push(" ");
      buffer$0.push(runtime_escape$0(props$6.get("b")));
      buffer$0.push("\n");
    } else {
      if (exit$5 === 1) {
        buffer$0.push(" Fail.\n");
    ...
    if (exit$6 === 0) {
      ...
      buffer$0.push(" ");
      buffer$0.push(runtime_escape$0(props$7.get("b")));
      buffer$0.push("\n");
    } else {
      if (exit$6 === 1) {
        buffer$0.push(" Fail.\n");
    ...
    if (!(props$0.get("null_string") === 0)) {
      buffer$1.push(runtime_escape$0(props$0.get("null_string")[0]));
    } else {
      buffer$1.push(runtime_escape$0("pass"));
    }
    ...
    buffer$0.push(
      Promise.all(blocks$0).then(
        (arg$13) => {
          ...
          buffer$3.push(runtime_escape$0(props$8.get("a")));
          buffer$3.push(" ");
          buffer$3.push(runtime_escape$0(props$8.get("b")));
          buffer$3.push("\n");
  ...
  "
    ...
    if (exit$7 === 0) {
      ...
      if (exit$7 === 1) {
        buffer$0.push(" 1 ");
        buffer$0.push(runtime_escape$0(props$8.get("x").toString()));
        buffer$0.push("\n");
      } else {
        if (exit$7 === 2) {
          buffer$0.push(" 2 ");
          buffer$0.push(runtime_escape$0(props$8.get("y").toString()));
          buffer$0.push("\n");
        } else {
          if (exit$7 === 3) {
            buffer$0.push(" 3\n");
    ...
    if (exit$8 === 0) {
      ...
      if (exit$8 === 1) {
        ...
        buffer$0.push(" ");
        buffer$0.push(runtime_escape$0(props$9.get("z").toString()));
        buffer$0.push("\n");
      }
    }
    ...
    if (exit$9 === 0) {
      ...
      if (exit$9 === 1) {
        ...
        buffer$0.push(" ");
        buffer$0.push(runtime_escape$0(props$10.get("z").toString()));
        buffer$0.push("\n");
      }
    }
    buffer$0.push(
  ...
  "
    ...
    buffer$0.push(runtime_escape$0(props$0.get("unicode_string")));
    buffer$0.push(
      "\n\
  \n\
